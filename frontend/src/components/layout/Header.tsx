...
export function Header({ organization, organizations, identity, signedIn, organizationSwitching = false, onOrganizationChange, theme, onToggleTheme, role, actualRole, onRoleChange, onOpenMenu, onSignOut }: { organization: OrganizationOption; organizations: OrganizationOption[]; identity?: { name: string; email: string }; signedIn: boolean; organizationSwitching?: boolean; onOrganizationChange: (organization: OrganizationOption) => void; theme: Theme; onToggleTheme: () => void; role: Role; actualRole: Role; onRoleChange: (role: Role) => void; onOpenMenu: () => void; onSignOut: () => void }) {
